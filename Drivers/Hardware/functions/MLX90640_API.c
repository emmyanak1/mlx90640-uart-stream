...
{
     return MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_EEPROM_START_ADDRESS, MLX90640_EEPROM_DUMP_NUM, eeData);
}
...
int MLX90640_SynchFrame(uint8_t slaveAddr)
{
    ...
    while(dataReady == 0)
    {
        error = MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_STATUS_REG, 1, &statusRegister);
...
int MLX90640_TriggerMeasurement(uint8_t slaveAddr)
{
    ...
    error = MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_CTRL_REG, 1, &ctrlReg);
...
int MLX90640_GetFrameData(uint8_t slaveAddr, uint16_t *frameData)
{
    ...
    error = MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_PIXEL_DATA_START_ADDRESS, MLX90640_PIXEL_NUM, frameData);
    if(error != MLX90640_NO_ERROR)
    {
        return error;
    }                       
    
    error = MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_AUX_DATA_START_ADDRESS, MLX90640_AUX_NUM, data);
    if(error != MLX90640_NO_ERROR)
    {
        return error;
    }     
        
    error = MLX90640_I2CRead_HALMem(slaveAddr, MLX90640_CTRL_REG, 1, &controlRegister1);
